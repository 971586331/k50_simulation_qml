...
ApplicationWindow {
    ...
    function switch_page(index)
    {
        switch(index)
        {
            case 1: splashLoader.setSource("qrc:/Page1Form.ui.qml");break;
            case 2: splashLoader.setSource("qrc:/Page2Form.ui.qml");break;
            case 3: splashLoader.setSource("qrc:/Page3Form.ui.qml");break;
        }
    }
...
//        }
    ...
    footer: TabBar {
        ...
        TabButton {
            text: qsTr("开关")
//            onClicked: switch_page(1)
        }
        TabButton {
            text: qsTr("运行")
//            onClicked: switch_page(2)
        }
        TabButton {
            text: qsTr("调试")
//            onClicked: switch_page(3)
        }
    }
}
